...
export default function WedgeILayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      {hasFounderAccess && !insideManagedAccounts ? (
        <div className="sticky top-0 z-[150] border-b border-[#c8a467]/20 bg-[#0a0e11]/95 px-5 py-3 text-[#f4efe6] shadow-[0_12px_40px_rgba(0,0,0,.22)] backdrop-blur sm:px-8">
