      ...
      <div className="border-b border-[#d2aa62]/20 bg-[#0a0f12] px-5 py-3 text-[#f3efe7]">
        <div className="mx-auto flex max-w-[1600px] flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-white/40">Platform oversight, subscriptions and product access</p>
          </div>
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/wedge-i/accounts" className="rounded-full bg-[#d2aa62] px-4 py-2 text-xs font-bold text-black">Open Wedge-I Business Hub</Link>
          </div>
        </div>
      </div>
      {children}
