      ...
      <section id="top" className="relative min-h-[820px] border-b border-white/8 bg-[#080c0f] pt-28">
        ...
        <div className="relative mx-auto grid min-h-[680px] max-w-7xl items-center gap-8 px-6 pb-16 lg:grid-cols-2">
          <div className="relative z-10">
            ...
            <div className="mt-9 flex flex-wrap gap-3"><a href="/clock-in" className="rounded-md bg-[#d2aa62] px-7 py-4 font-bold text-[#0d1316] shadow-[0_15px_40px_rgba(210,170,98,.18)]">Try WedgeCLOCKin Free</a><a href="#platform" className="rounded-md border border-[#5e8983]/70 px-7 py-4 font-semibold text-[#b9d7d2]">Explore Platform</a></div>
