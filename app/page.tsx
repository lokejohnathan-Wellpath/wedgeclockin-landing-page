    ...
    <main className="min-h-screen overflow-hidden bg-[#f4f0e8] text-[#17202a]">
      <div className="min-h-screen px-3 py-3 sm:px-6 sm:py-6">
        <div className="mx-auto max-w-[1280px] overflow-hidden rounded-[22px] border border-[#e8dfd0] bg-[#fffdfa] shadow-[0_28px_90px_rgba(78,58,28,.13)]">
          ...
          <section id="top" className="relative isolate px-6 pb-12 pt-12 sm:px-10 sm:pb-16 sm:pt-16 lg:px-16 lg:pb-20 lg:pt-20">
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[58%] opacity-80 [background:radial-gradient(ellipse_at_70%_78%,rgba(221,182,101,.5),transparent_23%),linear-gradient(159deg,transparent_33%,#eee6d9_34%,#f9f4ec_57%,transparent_58%),linear-gradient(171deg,transparent_58%,rgba(216,199,170,.58)_59%,transparent_61%)]" />
            <div className="pointer-events-none absolute right-[13%] top-[30%] h-28 w-28 rounded-full bg-[#dbb467] opacity-80 shadow-[0_0_55px_rgba(219,180,103,.36)] sm:h-36 sm:w-36" />
            <div className="relative z-10 max-w-[670px]"><p className="text-[10px] font-black tracking-[.28em] text-[#a77528]">PEOPLE · TIME · A STRONGER TOMORROW</p><h1 className="mt-5 text-4xl font-semibold leading-[1.04] tracking-[-.055em] sm:text-6xl lg:text-7xl">Smarter attendance <span className="text-[#a77528]">for stronger teams.</span></h1><p className="mt-6 max-w-[560px] text-base leading-7 text-[#66717b] sm:text-lg">Wedge Works brings people, time and daily operations into one simple system—so teams can work with clarity and businesses can keep moving forward.</p><div className="mt-8 flex flex-wrap gap-3"><a href="/clock-in" className="rounded-xl bg-[#ae7d2b] px-6 py-3.5 text-sm font-bold text-white shadow-[0_10px_22px_rgba(174,125,43,.2)] hover:bg-[#91651f]">Start Free <span className="ml-2">→</span></a><a href="#products" className="rounded-xl border border-[#c69b54] px-6 py-3.5 text-sm font-bold text-[#6e5938] hover:bg-[#fbf4e8]">Explore Platform</a></div></div>
            <div className="relative z-10 mt-16 flex flex-wrap items-end justify-between gap-8 border-t border-[#eadfcd] pt-7"><p className="max-w-[260px] text-xs font-medium leading-5 tracking-[.15em] text-[#8b775c]">SIMPLE · RELIABLE · PEOPLE FIRST</p><p className="max-w-[225px] text-right font-serif text-lg italic leading-5 text-[#796854]">“A more productive tomorrow, together.”</p></div>
          </section>
